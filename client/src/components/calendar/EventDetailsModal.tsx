        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-3xl bg-[var(--bg-sidebar)] rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] print:shadow-none print:w-full print:max-w-none print:m-0 print:rounded-none">
                ...
                <div className="flex flex-row flex-1 overflow-hidden min-h-0">
                    ...
                    <div className="w-14 sm:w-56 shrink-0 bg-[var(--bg-sidebar)] border-r border-[var(--border-main)] overflow-y-auto print:hidden p-2 flex flex-col gap-1 sm:gap-2">
                        {tabs.map((tab) => {
                    ...
                    {/* Body */}
                    <div className="p-4 sm:p-8 space-y-8 overflow-y-auto flex-1 min-w-0 print:max-h-none print:p-0 print:overflow-visible bg-[var(--bg-main)]">
                                    ...
                                    <div className="pt-4">
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-[10px] text-[var(--text-muted)] font-mono bg-[var(--bg-main)] p-3 rounded border border-[var(--border-main)] print:border-gray-200">
                                            <div>
                                                ...
                                                <span className="select-all break-all">{event.id}</span>
                                            </div>
                                            <div>
                            ...
                            <div className={clsx(activeTab === 'lineup' ? 'block' : 'hidden print:block', "animate-in fade-in slide-in-from-bottom-2 duration-300 print:animate-none print:mt-8")}>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 gap-3">
                                        {(() => {
                                            const lineupObj = event.details_lineup || {};
                                            const lineupKeys = Object.keys(lineupObj)
                                            ...
                                            // Fallback to 1..5 if empty for legacy support or display
                                            const keysToRender = lineupKeys.length > 0 ? lineupKeys : ['atracao1', 'atracao2', 'atracao3', 'atracao4', 'atracao5'];
                                            ...
                                            return keysToRender.map((key) => {
                                                ...
                                                // Only show if there's actually data to show, unless it's the first one to show it's empty
                                                if (display === '-' && lineupKeys.length > 0) return null;
